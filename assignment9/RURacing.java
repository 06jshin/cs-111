...
public class RURacing {
	...
	// WRITE YOUR CODE HERE
        ...
        int[] points = moveRacer(0, 0, distance, map); 
        System.out.println("Racer1 is at: (" + points[0] + "," + points[1] + ")");
    }
	...
	// WRITE YOUR CODE HERE
        ...
        int x = 0;
        int y = 0;
        while(curDis * 2 < totDis) {
            int[] points = moveRacer(x,y,curDis,map);
            System.out.println("Racer2 is at: (" + points[0] + "," + points[1] + ")");
	...
	// WRITE YOUR CODE HERE
        ...
        int x = 0;
        int y = 0;
        for(int i = 1; i <= totDis; i++) {
            int[] points = moveRacer(x,y,1,map);
            System.out.println("Racer3 is at: (" + points[0] + "," + points[1] + ")");
            x = points[0];
            y = points[1];
        }
    }
	...
	// WRITE YOUR CODE HERE
        ...
        for(int i = 1; i < totDis; i++) {
            int[] points = moveRacer(x,y,1,map);
            for(int j = 1; j < totDis; j++) {
                System.out.println("Racer4 is at: (" + points[0] + "," + points[1] + ")");
            }
            x = points[0];
            y = points[1];
        }
